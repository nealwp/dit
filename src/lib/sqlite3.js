...
exports.updateEntry = exports.deleteEntry = exports.getEntry = exports.getAllEntries = exports.getMonthyReport = exports.getTodaysEntries = exports.addBackdatedEntry = exports.addEntry = exports.initializeDB = exports.getDBVersion = void 0;
...
const addBackdatedEntry = (entryDate, entry) => {
    return new Promise((resolve, reject) => {
        const sql = (0, fs_1.readFileSync)('./src/sql/insert_backdate_entry.sql', { encoding: 'utf8' });
...
exports.addBackdatedEntry = addBackdatedEntry;
